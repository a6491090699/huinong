...
<form method="post" id="address_form">
    <div class="bd_top_bottom-eee bg-fff padding_flanks">
        <div class="form_item">
            ...
            <input type="text" class="consignee" name="consignee" value=""  placeholder="收货人姓名"/>
        </div>
        <div class="form_item">
            <span class="font_3r color_34 goods_name-title">联系电话</span>
            <input type="text" class="consignee" name="phone_tel" value="" placeholder="电话"/>
        </div>
        <div class="form_item">
            <span class="font_3r color_34 goods_name-title">手机</span>
            <input type="number" class="consignee" name="phone_mob" value=""  placeholder="手机"/>
        </div>
        ...
        <textarea class="detailed_address" name="address" id="address" cols="30" rows="3" placeholder="地址"></textarea>
    </div>
    <div class="padding_flanks bg-fff default_setting_btn bd_top_bottom-eee">
        <div class="form_item">
            ...
            <a class="input_radio-right ">
                <input type="radio" class="input-select" name="is_default" value="1"/>
            </a>
        </div>
    </div>
