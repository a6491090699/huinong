...
//        search_goods_tpl += '    <span class="min_sell-num">库存：{stock}{goods_unit}</span>';
        ...
        goods_tpl += '<img src="{litpic}" style="height:103.4px;width:103.4px;object-fit:cover;">';
        goods_tpl += '</dt>';
...
//        search_tuiguang_goods_tpl += '    <span class="min_sell-num">库存：{stock}{goods_unit}</span>';
        ...
        $(function() {
            ...
            $('#loading01').click(function () {
                ...
                var url = '/api/supply-all?keyword=' + keyword + '&page=' + page+'&order='+order+'&region_id='+region_id+'&mid='+mid;
