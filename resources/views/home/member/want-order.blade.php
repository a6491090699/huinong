...
<div>
    <ul class="order_nav-list bg-fff bd_top_bottom-eee font_3r clearfix">
        <li class="hover_list">
        <div><a href="#?app=buyer_order&type=all_orders">全部</a></div>
        </li>
        <li >
        <div><a href="#?app=buyer_order&type=pending">待付款</a></div>
        </li>
        <li >
        <div><a href="#?app=buyer_order&type=accepted">待发货</a></div>
        </li>
        <li >
        <div><a href="#?app=buyer_order&type=shipped">已发货</a></div>
        </li>
        <li >
        <div><a href="#?app=buyer_order&type=finished">待评价</a></div>
        </li>
    </ul>
