...
</head><script type="text/javascript" src="/js/ueditor.config.js"></script><script type="text/javascript" src="/js/ueditor.all.min.js"></script>
...
<script>
    ...
    //商品分类
    var gcategory_data_url = "/index.php?app=mlselection&act=gcategory4app";
...
<script type="text/javascript" src="/js/my_goods.form.new.js"></script>
