...
<div>
    <ul class="order_nav-list bg-fff bd_top_bottom-eee font_3r clearfix">
        ...
        <div><a href="/yuyue/my-yuyue?type=all">全部</a></div>
        </li>
        <li  class="wait-comfirm">
        <div><a href="/yuyue/my-yuyue?type=wait-comfirm">待确认</a></div>
        </li>
        <li class="wait-look">
        <div><a href="/yuyue/my-yuyue?type=wait-look">待看货</a></div>
        </li>
        <li class="wait-comment">
        <div><a href="/yuyue/my-yuyue?type=wait-comment">待评价</a></div>
        </li>
		<li class="finish">
        <div><a href="/yuyue/my-yuyue?type=finish">已评价</a></div>
        </li>
    </ul>
...
$('.{!!$type!!}').addClass('hover_list');
    ...
    yuyue_tpl += '<span class="font_28r color_34" onclick="location=\'{store_url}\';">{seller_name}<b class="iconfont fontWeight_4 padding_flanks color_9a">&#xe614;</b></span>';
    yuyue_tpl += '<span class="font_24r fr color_02c5a3">{status_text}</span>';
    ...
    yuyue_tpl += '<span style="color:#FF3a3a">商家留言：{message}</span>';
        ...
        $('#loading01').click(function(){
            ...
            $.getJSON(url, function(result){
                ...
                for(var i = 0; i < result.data.length; i++){
                    ...
                    switch (item.status) {
                        case 0:
                            item.status_text = '待确认'; //状态
                            break;
                        case 1:
                            item.status_text = '待看货';
                            break;
                        case 2:
                            item.status_text = '已看货';
                            break;
                        case 3:
                    ...
                    switch (item.status) {
                        case 0:
                        buttons += '<a class="border_box-02c5a3 font_24r color_02c5a3" href="/yuyue/cancel/'+item.id+'">取消预约</a>';
                            break;
                        case 1:
