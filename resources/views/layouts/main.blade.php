...
<head lang="en">
    ...
    <title>@yield('title') - 中国花木在线交易专业平台</title>
...
<div class="sell_index-main">
    ...
    <div class="padding_flanks bg-fff bd_top_bottom-eee" style="display:none;">
        <div class="store_padding border_none">
            <a class="a_full position_relative" href="/fenlei">
                <span class="font_3r color_34 goods_name-title">全部分类</span>
    ...
    <div class="margin-top_12 bg-fff text_center padding_top_bottom color_67 bd_top-eee">
        <div class="copyright-con padding_top_bottom">
            <p>
                地球村&nbsp;&nbsp;竞苗平台&nbsp;&nbsp;XXXX.com
            </p>
            <p>2017-09-09 &nbsp;&nbsp; 电话:8888-8888-888</p>
        </div>

    </div>
</div>

<div class="hunt_popup" style="display: none">
    <header class="hunt_head">
        <a class="hunt_header_abolish color_02c5a3">取消</a>
        <div>
            <input type="text" id="keyword"/>
            <a class="color_fff" onclick="#">搜索</a>
        </div>
    </header>
    <div class="hunt_main padding_flanks">
        ...
        <ul class="hunt_hot_list clearfix">
                        ...
                        <li><a href="#">红豆杉</a></li>
                        <li><a href="#">樱花</a></li>
                        <!--<li><a href="./index.php?app=search&act=index&keyword=%E7%BA%A2%E5%8F%B6%E7%9F%B3%E6%A5%A0">红叶石楠</a></li>-->
                    </ul>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function popup_hunt(){
        ...
        $("body").css("height",ww).css("overflow","hidden");
        $(".hunt_popup").show();
        $(".hunt_head input").focus();
    }
    //关闭搜索弹出
    function close_popup_hunt(){
        $(".hunt_popup").hide();
        $("body").css("height","").css("overflow","auto");
    }
    $(".hunt_input").click(function(){
        popup_hunt();
    });
    $(".hunt_header_abolish").click(function(){
        close_popup_hunt();
    });
