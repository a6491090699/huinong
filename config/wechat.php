...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx2132a5e4f9ee3e7b'),         // AppID
    'secret'  => env('WECHAT_SECRET', 'd8cb536d96c3bf41b28e02b4a5a758e9'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'yytest'),          // Token
     ...
     */
    'payment' => [
        'merchant_id'        => env('WECHAT_PAYMENT_MERCHANT_ID', '1358455102'),
    ...
    'mock_user' => [
        ...
        'city' => '厦门',
        'country' => '中国',
        'headimgurl' => 'http://wx.qlogo.cn/mmopen/vi_32/PiajxSqBRaEJzickbJgw3HSKdiaJVUcVPYQsU0icICVrXpXOPGAX9q109yaDPlXykdpYeNqm3amMialB6a62oR6Zy1g/0',
    ],
];
